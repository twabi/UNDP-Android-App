...
public class SessionManager {
    ...
    private static final String PREF_NAME = "WasteMgmt";
    ...
    public static final String KEY_NATIONALID = "nationalID";
     ...
     * */
    public void createLoginSession(String id, String nationalID, String status){
        ...
        editor.putString(KEY_NATIONALID, nationalID);
    ...
    public HashMap<String, String> getUserDetails(){
        ...
        // user number id
        user.put(KEY_NATIONALID, pref.getString(KEY_NATIONALID, null));
